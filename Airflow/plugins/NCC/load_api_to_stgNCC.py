...
# Chạy chương trình
def run_load_api_to_stgNCC():
    # Đường dẫn API và thông tin kết nối DB
    api_url_NCC = "http://host.docker.internal:8000/NCC" # Đường dẫn API cho bảng
    ...
    # Lấy dữ liệu từ API
    api_data = fetch_data_from_api(api_url_NCC)

    # Chèn dữ liệu vào bảng tương ứng
    insert_data_to_db(db_connection, api_data, 'insert_Stg_DimNCC')
